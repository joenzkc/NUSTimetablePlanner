...
const TimetableMaker = (
  ...
  if (!state.lecture) {
    ...
    const filteredSat = filterEvents.saturday.filter((x) => x.type !== "Lecture");
  ...
  if (!state.tutorial) {
    ...
    const filteredSat = filterEvents.saturday.filter((x) => x.type !== "Tutorial");
    const filteredSun = filterEvents.sunday.filter((x) => x.type !== "Tutorial");
    filterEvents = {
      monday: filteredMon,
      tuesday: filteredTue,
      wednesday: filteredWed,
  ...
  if (!state.labs) {
    ...
    const filteredSat = filterEvents.saturday.filter((x) => x.type !== "Laboratory");
    const filteredSun = filterEvents.sunday.filter((x) => x.type !== "Laboratory");
    filterEvents = {
      monday: filteredMon,
      tuesday: filteredTue,
      wednesday: filteredWed,
  ...
  if (!state.others) {
    ...
    const filteredSat = filterEvents.saturday.filter((x) => x.type === "Lecture" || x.type === "Tutorial" || x.type === "Laboratory");
    const filteredSun = filterEvents.sunday.filter((x) => x.type === "Lecture" || x.type === "Tutorial" || x.type === "Laboratory");
    filterEvents = {
      monday: filteredMon,
      tuesday: filteredTue,
      wednesday: filteredWed,
